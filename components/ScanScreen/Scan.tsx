...
const Scan: React.FC<ScanProps> = ({
  ...
  return (
    ...
    >
      {/* Halal Check Message */}
      {isCheckHalal && (
        <View style={styles.halalMessageContainer}>
          <Text style={styles.halalMessageText}>
            {t(LanguageKey.HALAL_CHECK_ONLY_MESSAGE)}
          </Text>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  // Halal Check Message Styles
  halalMessageContainer: {
    position: "absolute",
    top: 60,
    left: 20,
    right: 20,
